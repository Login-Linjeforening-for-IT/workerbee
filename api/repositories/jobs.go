...
func (r *jobsrepositories) GetJobsCities() ([]models.Cities, error) {
	...
	var sqlBytes, err = os.ReadFile("./db/jobs/get_cities.sql")
	if err != nil {
		return nil, err
	}

	err = r.db.Select(&cities, string(sqlBytes))
	if err != nil {
		return nil, err
	}
	return cities, nil
...
func (r *jobsrepositories) GetJobTypes() ([]models.JobType, error) {
	var jobTypes []models.JobType

	var sqlBytes, err = os.ReadFile("./db/jobs/get_types.sql")
	if err != nil {
		return nil, err
	}

	err = r.db.Select(&jobTypes, string(sqlBytes))
	if err != nil {
		return nil, err
	}
	return jobTypes, nil
