...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.AlbumsWithTotalCount"
                            }
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.AlbumWithImages"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v2/albums/{id}/cover/{imageName}": {
            "put": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v2/albums/{id}/images/{imageName}": {
            "delete": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v2/alerts/service/{service}/page/{page}": {
            "get": {
        ...
        "/api/v2/audiences/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated audience object",
                        "name": "audience",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.NewEvent"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v2/honey/{service}/content/{path}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Path in the service",
                        "name": "path",
                        "in": "path",
                        "required": true
                    }
        ...
        "/api/v2/honey/{service}/content/{path}/{language}": {
            "get": {
        ...
        "/api/v2/images/upload/{path}": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Path to upload the image",
                        "name": "path",
                        "in": "path",
                        "required": true
                    },
        ...
        "/api/v2/images/{path}/{imageName}": {
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Path where the image is located",
                        "name": "path",
                        "in": "path",
                        "required": true
                    },
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.JobSkills"
                            }
                        }
                    },
                    "500": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.NewAddition"
                            }
                        }
                    },
                    "500": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.YearlyActivity"
                            }
                        }
                    },
                    "500": {
    ...
    "definitions": {
        ...
        "models.AlbumWithImages": {
            ...
            "properties": {
                ...
                "event": {
                    "$ref": "#/definitions/models.EventAlbum"
                },
                "id": {
                    "type": "integer"
                },
        ...
        "models.Submission": {
            ...
            "properties": {
                ...
                "questions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.QuestionWithAnswer"
                    }
                },
                "submitted_at": {
                    "type": "string"
        ...
        "models.YearlyActivity": {
            "type": "object",
            "properties": {
                "insert_date": {
                    "$ref": "#/definitions/internal.Date"
                },
                "inserted_count": {
                    "type": "integer"
                }
