...
type Event struct {
	...
	Visible            bool       `db:"visible" json:"visible" validate:"omitempty"`
	...
	TimeType           string     `db:"time_type" json:"time_type" validate:"omitempty"`
	...
	Canceled           bool       `db:"canceled" json:"canceled" validate:"omitempty"`
	Digital            bool       `db:"digital" json:"digital" validate:"omitempty"`
	Highlight          bool       `db:"highlight" json:"highlight" validate:"omitempty"`
	...
	IsFull             bool       `db:"is_full" json:"is_full" validate:"omitempty"`
	Category           *int       `db:"category_id" json:"category_id" validate:"required"`
	CategoryNameNo     *string    `db:"category_name_no" json:"category_name_no" validate:"required"`
	CategoryNameEn     *string    `db:"category_name_en" json:"category_name_en" validate:"required"`
	Location           *int       `db:"location_id" json:"location_id,omitempty" validate:"omitempty"`
	LocationNameNo     *string    `db:"location_name_no" json:"location_name_no" validate:"omitempty"`
	LocationNameEn     *string    `db:"location_name_en" json:"location_name_en" validate:"omitempty"`
	...
	AudienceNameEn     *string    `db:"audience_name_en" json:"audience_name_en" validate:"omitempty"`
	AudienceNameNo     *string    `db:"audience_name_no" json:"audience_name_no" validate:"omitempty"`
	Organization       *int       `db:"organization_id" json:"organization_id,omitempty" validate:"omitempty"`
	OrganizerNameNo    *string    `db:"organizer_name_no" json:"organizer_name_no" validate:"omitempty"`
	OrganizerNameEn    *string    `db:"organizer_name_en" json:"organizer_name_en" validate:"omitempty"`
