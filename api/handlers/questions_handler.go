...
// GetQuestions godoc
// @Summary      Get questions for a form
// @Description  Returns all questions for a form by form ID
// @Tags         questions
// @Param        form_id   path      string  true  "Form ID"
// @Success      200  {array}  models.QuestionWithOptions
// @Failure      500  {object}  error
// @Router       /api/v2/forms/{form_id}/questions [get]
func (h *Handler) GetQuestions(c *gin.Context) {
	formID := c.Param("id")

	questions, err := h.Questions.GetQuestions(formID)
	if err != nil {
...
// PostQuestions godoc
// @Summary      Create questions for a form
// @Description  Accepts an array of questions and inserts them
// @Tags         questions
// @Accept       json
// @Produce      json
// @Param        form_id   path      string  true  "Form ID"
...
// @Router       /api/v2/forms/{form_id}/questions [post]
func (h *Handler) PostQuestions(c *gin.Context) {
	...
	newQuestions, err := h.Questions.PostQuestions(formID, questions)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
	
	c.JSON(http.StatusCreated, newQuestions)
}
